...
// BenchmarkLogger_TraditionalStyle 基准测试传统风格
...
// BenchmarkLogger_ChainStyle 基准测试链式风格
...
// BenchmarkLogger_Printf 基准测试 Printf 风格
func BenchmarkLogger_Printf(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		log.Printf("Benchmark message: %d, %s", i, "test data")
	}
}
